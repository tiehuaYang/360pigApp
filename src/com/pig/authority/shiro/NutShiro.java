...
public class NutShiro {
   ...
   public static String DefaultNoAuthURL = "/manage/showNoAuth"; // 默认与DefaultLoginURL一致
   ...
   public static boolean isAppApply(ServletRequest req) {
      String value = ((HttpServletRequest) req).getHeader("applyType");

      if (value != null && "application".equalsIgnoreCase(value.trim())) {
         return true;
      }
      return false;
   }
