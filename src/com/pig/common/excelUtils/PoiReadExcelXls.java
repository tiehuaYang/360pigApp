...
public class PoiReadExcelXls {

   /**
    * POI解析后缀为.xls的Excel文件内容
    */
   public static Map<String, Object> createExcelXlsList(List<ExcelVO> list, String realFileName, String templateName) {
      ...
      try {
         ...
         //创建Excel，读取文件内容
         HSSFWorkbook workbook = new HSSFWorkbook(FileUtils.openInputStream(new File(realFileName)));
...
//            System.out.println();
    ...
    * @return
    */
   private static String getCellValue(HSSFCell cell, Element td) {
      //首先获取单元格位置
