...
<body class = "${theme }" >
  <div>
                                            ...
                                            <!--  查询条件表单    -->
	                                                <div class="col-lg-12">
		                                                <div class="portlet box">
							                                ...
							                                <%-- <div class="portlet-body" style="display: none;">
							                                    <form id="searchForm" action="${contextPath}/manage/showMsgList" class="horizontal-form" method="POST" >
				                                ...
				                                <div class="row">
														<div class="col-lg-12" style="margin-left:15px;">
															<form id="Phidden" action="${contextPath }/manage/showMsgList" method="post">
																...
																<div class="pagination-panel" style="margin-left:-10px;"> 每次浏览&nbsp; 
	                                                        		...
	                                                        		<input id="userName" name="userName" onclick="ev_showUser();return false;" style="width: 120px" type="text" placeholder="点击选择养户"  class="form-control input-sm input-inline" value="${obj.queryMap.userName}"/>
		                                            ...
		                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
		                                                ...
		                                                <c:forEach var="alarmVO" items="${obj.alarmList}" varStatus="status">
		                                                	<tr>
		                                                        ...
		                                                        <td>
		                                                            <button type="button" class="btn btn-default btn-xs" onclick="finishAlarm('${alarmVO.alarmId}')"><i class="fa fa-edit"></i>&nbsp; 处理完成</button>
		                                                        </td>
		                                                    </tr>
		                                                </c:forEach>
		                                                </tbody>
    ...
    $(document).ready(function(){
		activeMenu("msgManage","msgUL","errMsgMenu");
        ...
        function finishAlarm(id){
        	if(window.confirm("确定这条记录已经完成并归档吗？确定后可在告警历史中找到历史记录。")){
        	  var url = "${contextPath}/manage/finishAlarm?alarmId="+id;
...
/* 			var pageSize = $( "select[name=pageSize] option:selected").val();
			...
			var url = "${contextPath}/manage/showMsgList?currentPage=" + currentPage + "&pageSize=" + pageSize
