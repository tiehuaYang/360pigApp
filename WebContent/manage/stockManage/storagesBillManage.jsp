...
<body class = "${theme }" >
  <div>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                 <div class="page-header pull-left">
						<div class="page-title">出入库明细</div>
					</div>
                    ...
                    <div id="table-advanced" class="row">
                        <div class="col-lg-12">
                            <ul id="tableadvancedTab" class="nav nav-tabs">
                                <li class="active"><a href="#table-sticky-tab" data-toggle="tab">出入库明细</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="portlet box">
				                                ...
				                                <div class="row">
	                                                    ...
	                                                    <a href="${contextPath}/manage/newOutStorages"  class="btn btn-info btn-xs">
	                                                    	<i class="fa fa-plus"></i>&nbsp;新增出库
	                                                    </a>
                                            	...
                                            	<div class="portlet-body">
		                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter tb-sticky-header">
		                                                ...
		                                                <tbody>
		                                                <c:forEach var="storagesVO" items="${obj.storagesList}" varStatus="status">
		                                                	<tr>
		                                                		<%-- <c:forEach var="inventoryVO" items="${obj.inventoryList}" varStatus="status">
		                                                			<c:if test="${inventoryVO.goodId == storageVO.goodId}"> --%>
		                                                        		...
		                                                        		<td>${storagesVO.billCode}</td>
		                                                        		<td><fmt:formatDate value="${storagesVO.createTime}" type="both"/></td>
		                                                        		<td>
		                                                        		<c:if test="${storagesVO.storageKind == 1}">
		                                                        			+${storagesVO.storageNum}
		                                                        		</c:if>
		                                                        		<c:if test="${storagesVO.storageKind == 0}">
		                                                        			-${storagesVO.storageNum}
		                                                        		</c:if>
		                                                        		</td>
		                                                        		<td>${storagesVO.currentNum}</td>
		                                                            <%-- </c:if>
		                                                        </c:forEach> --%>
		                                                    </tr>
		                                                </c:forEach>
    ...
    $(document).ready(function(){
		activeMenu("stockManage","stockUL","storagesList");
    ...
    function input_submit(id){
    	...
    	function jumpPage(currentPage){
    		var pageSize = $("select[name=pageSize] option:selected" ).val();
    		var url = "${contextPath}/manage/showStoragesList?currentPage="+currentPage +"&pageSize=" + pageSize;
        	window.location.href = url;
    	}
